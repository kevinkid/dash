...
/// Signin route 
router.get('/signin/:account/', function (req, res) {
    res.redirect(accountsFactory.getAuthUrl(req.params.account));
});

/// Web hooks subscription route 
router.get('/callback/:account', function (req, res) {
    var subscriptionConfig = config.accounts[req.params.account].subscriptionConfiguration;
...
router.get('/callback', function (req, res) {
    ...
    if (true) {
        ...
        authHelper.getToken(req.query.code, function (authorizeError, token, refreshToken) {
            ...
            // TODO: Redirect instead to get the account type from the client .
            res.redirect('./callback.html?code='+req.query.code+"&clientState="+req.query.clientState);
